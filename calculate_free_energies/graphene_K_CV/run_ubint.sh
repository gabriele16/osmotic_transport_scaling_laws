...
echo "Extract free energy of K+ on graphene"

export GRAKDIR=$PWD
export BNKDIR=$PWD/../hbn_K_CV
...
do
	...
	echo ${colv_data_path} ${loc_win_min} ${spring} >> ${GRAKDIR}/${met_file}
...
umbrellaint.py ${met_file}  26 10000 40000 -T 300 -o FreeEnergyGraK.dat -c 3 --split no
