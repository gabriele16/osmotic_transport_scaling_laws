...
echo "Extract free energy of I- on graphene"

export GRAIDIR=$PWD
export BNIDIR=$PWD/../hbn_I_CV
...
do
	...
	echo ${colv_data_path} ${loc_win_min} ${spring} >> ${GRAIDIR}/${met_file}
...
umbrellaint.py ${met_file}  26 10000 70000 -T 300 -o FreeEnergyGraI.dat -c 3 --split no
